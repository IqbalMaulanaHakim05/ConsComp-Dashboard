...
// Hanya izinkan tujuan lokal sederhana.
if (!preg_match('/^[a-zA-Z0-9_\-.]+(?:\?[a-zA-Z0-9_=&%\-.]*)?$/', $next)) {
    $next = 'index.php';
}
...
<div class="login-layout">
    ...
    <main class="login-panel">
        ...
        <p class="hint">Akun awal: <strong>admin</strong>. Demi keamanan, ubah password hash pada <code>auth.php</code> sebelum aplikasi digunakan secara publik.</p>
    </main>
</div>
<script>
