...
) ENGINE=InnoDB AUTO_INCREMENT=39521 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `master_posisi` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `nama` (`nama`)
) ENGINE=InnoDB AUTO_INCREMENT=54886 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `schema_migrations` VALUES ('001','create_schema_migrations','2026-08-10 04:04:25'),('002','normalize_departments_and_histories','2026-08-10 04:08:56');
...
-- Dump completed on 2026-08-10 11:10:14
