...
INSERT INTO `jenis_komponen_gaji` VALUES (1,'1','A','pendapatan','nominal',1);
...
INSERT INTO `komponen_gaji_karyawan` VALUES (2,21,1,10000.00);
...
) ENGINE=InnoDB AUTO_INCREMENT=39737 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `master_posisi` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `nama` (`nama`)
) ENGINE=InnoDB AUTO_INCREMENT=55186 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `overtime_approvals` VALUES (1,1,'koordinator','approved',7,'','2026-08-10 11:59:04','2026-08-10 04:56:34'),(2,1,'manager','approved',6,'','2026-08-10 11:59:26','2026-08-10 04:56:34');
...
INSERT INTO `overtime_compensations` VALUES (1,1,'per_jam',50000.00,100000.00,8,'2026-08-10 05:10:20','2026-08-10 05:10:20');
...
INSERT INTO `overtime_reports` VALUES (1,404,16,8,'2026-08-10 11:55:00','2026-08-10 17:01:00',306,'tugas tambahan','disetujui','2026-08-10 11:56:34','2026-08-10 04:56:31','2026-08-10 04:59:26');
...
-- Dump completed on 2026-08-10 13:29:19
