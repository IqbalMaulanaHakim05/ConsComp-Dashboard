...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    if ($nama === "" || $judul === "" || $deskripsi === "" || $tombol === "") {
        ...
        mysqli_stmt_bind_param(
            ...
            $warnaGrafikStatus, $warnaGrafikTren, $warnaGrafikPosisi, $warnaGrafikDepartemen, $warnaGrafikGaji, $warnaGrafikPerforma,
            $kolomPublikJson, $kartuDashboardJson
        );
    ...
    <section class="form-card">
        ...
        <div class="form-body">
            ...
            <form method="POST">
                ...
                <section class="settings-section-card">
                    <div class="settings-section-heading"><span class="settings-section-icon">▤</span><div><h3>Kartu Dashboard</h3><p>Pilih kartu statistik yang ditampilkan pada halaman Dashboard.</p></div></div>
                    <div class="form-grid">
