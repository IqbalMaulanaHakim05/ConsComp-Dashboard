...
require_once __DIR__ . '/fungsi/alur-persetujuan-izin.php';
...
$judulHalaman = 'Cuti Khusus'; $subjudulHalaman = 'Pengajuan cuti khusus dengan pilihan deskripsi yang terstandar.'; $halamanAktif = 'izin-cuti-khusus'; $kelasHalaman = 'izin-cuti'; require __DIR__ . '/partials/atas.php';
?>
