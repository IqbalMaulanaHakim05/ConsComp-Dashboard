...
<head>
    ...
    <?php if ($cssHalamanAktif !== ""): ?>
        <link rel="stylesheet" href="<?= htmlspecialchars($urlStyle . $cssHalamanAktif); ?>?v=<?= $halamanAktif === "upah" ? "20260813-upah-preview-table12" : ($halamanAktif === "lembur" ? "20260813-lembur-preview-table2" : ($halamanAktif === "karyawan" ? "20260811-karyawan-columns1" : ($halamanAktif === "dashboard" ? "20260811-dashboard-columns5" : "20260811-layout8"))); ?>">
    <?php endif; ?>
</head>
