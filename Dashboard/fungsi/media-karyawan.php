...
{
    foreach (["nik" => "VARCHAR(50) NULL", "alamat" => "TEXT NULL", "biografi" => "TEXT NULL", "keahlian" => "TEXT NULL", "riwayat_pekerjaan" => "TEXT NULL", "tanggal_riwayat_pekerjaan" => "DATE NULL", "riwayat_pendidikan" => "TEXT NULL", "tanggal_riwayat_pendidikan" => "DATE NULL", "tanggal_lahir" => "DATE NULL", "tanggal_mcu_terakhir" => "DATE NULL", "agama" => "VARCHAR(50) NULL", "marital_status" => "VARCHAR(50) NULL", "kontak" => "VARCHAR(50) NULL", "email" => "VARCHAR(150) NULL"] as $kolom => $tipe) {
        $aman = mysqli_real_escape_string($conn, $kolom);
        $cek = mysqli_query($conn, "SHOW COLUMNS FROM karyawan LIKE '$aman'");
